...
**Note:** This example will be using the rhbase version provided by Aaron Benz, forked from Revo R's repo on github. For more information check out github.com/aaronbenz

**Assumption:** Followed rhbase_part1, meaning HBase and thrift are running, rhbase is installed, and data is available in HBase.
