...
###HBase Frame of Mind
  ...
  - Data modeling: **Based off query patterns and stored directly**. Cross-table joins are a BAD thing (Spark can help with this, but that does not mean you should design to do any kind of joins). Essentially you are sacrificing complex querying for huge speed gains.
